...
export const deleteDish = async (dishId) => {
  try {
    const response = await api.delete(`${API_ENDPOINTS.DELETE_DISH}/${dishId}`);
    return response.data;
  } catch (error) {
    throw error;
  }
...
export const addCategory = async (categoryData) => {
  try {
    const response = await api.post(API_ENDPOINTS.ADD_CATEGORY, categoryData);
    return response.data;
  } catch (error) {
    throw error;
  }
...
export const editCategory = async (categoryData) => {
  try {
    const response = await api.patch(API_ENDPOINTS.EDIT_CATEGORY, categoryData);
    return response.data;
  } catch (error) {
    throw error;
  }
...
export const deleteCategory = async (categoryId) => {
  try {
    const response = await api.delete(`${API_ENDPOINTS.DELETE_CATEGORY}/${categoryId}`);
    return response.data;
  } catch (error) {
    throw error;
  }
