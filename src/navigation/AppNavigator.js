...
const MainNavigator = () => (
  ...
  >
    ...
    <Drawer.Screen name="RestaurantProfile" component={RestaurantProfileScreen} options={{ title: 'Restaurant Profile' }} />
    <Drawer.Screen name="RestaurantGallery" component={RestaurantGalleryScreen} options={{ title: 'Gallery' }} />
    <Drawer.Screen name="RestaurantSettings" component={RestaurantSettingsScreen} options={{ title: 'Settings' }} />
    ...
    <Drawer.Screen name="QRCode" component={QRCodeScreen} options={{ title: 'QR Code' }} />
