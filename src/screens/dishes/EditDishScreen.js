...
const EditDishScreen = ({ navigation, route }) => {
  ...
  const fetchDishAndCategories = async () => {
    try {
      setLoading(true);
      setError(null);
      ...
      if (dishResponse && dishResponse.data && dishResponse.data.dish) {
        const dishData = dishResponse.data.dish;
        setDish(dishData);
        setImage(dishData.image);
      } else {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      // Update dish
      await dishService.editDish(dishData);
    ...
    return (
      <View style={styles.container}>
        <Appbar.Header style={styles.header}>
          ...
          <Appbar.Content title="Edit Dish" />
        </Appbar.Header>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <Formik
            initialValues={{
              ...
              veg: dish.veg !== undefined ? dish.veg : false,
            }}
