  ...
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve({
        data: {
          rooms: [
            { _id: '1', roomNumber: '101', capacity: 10, description: 'Conference Room', status: 'available' },
            { _id: '2', roomNumber: '102', capacity: 20, description: 'Banquet Hall', status: 'occupied' },
            { _id: '3', roomNumber: '103', capacity: 15, description: 'Private Dining', status: 'reserved' },
          ]
        }
      });
    }, 1000);
    ...
    <Card style={styles.card}>
      <Card.Content>
        <View style={styles.roomHeader}>
          <Title style={styles.roomTitle}>Room {item.roomNumber}</Title>
        ...
        <View style={styles.roomInfo}>
          ...
          <Text style={styles.infoValue}>{item.description || 'No description'}</Text>
        </View>
      </Card.Content>
    ...
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Ionicons name="home-outline" size={64} color={COLORS.lightGray} />
      ...
      <Portal>
        ...
        <Dialog visible={deleteDialogVisible} onDismiss={() => setDeleteDialogVisible(false)}>
          ...
          <Dialog.Content>
            <Paragraph>Are you sure you want to delete Room {selectedRoom?.roomNumber}?</Paragraph>
            <Paragraph>This action cannot be undone.</Paragraph>
          </Dialog.Content>
          <Dialog.Actions>
            <Button onPress={() => setDeleteDialogVisible(false)}>Cancel</Button>
            <Button onPress={handleDeleteRoom} color={COLORS.error}>Delete</Button>
          </Dialog.Actions>
        </Dialog>
      </Portal>
    </View>
