  ...
  const fetchQrCodeData = async () => {
    try {
      ...
      if (response && response.data && response.data.qrCodeData) {
        ...
        const defaultQrData = `https://qrsay.web.app/restaurant/${restaurantData?._id || 'unknown'}`;
        ...
        <Card containerStyle={styles.card}>
          ...
          <View style={styles.infoContainer}>
            ...
            <View style={styles.infoItem}>
              <Icon name="print" size={16} color="#666" style={styles.infoIcon} />
              <Text style={styles.infoText}>Print this QR code and place it on your tables or menu cards</Text>
            </View>
            <View style={styles.infoItem}>
              <Icon name="mobile" size={16} color="#666" style={styles.infoIcon} />
              <Text style={styles.infoText}>Customers can scan it with their smartphone camera</Text>
            </View>
            <View style={styles.infoItem}>
              <Icon name="cutlery" size={16} color="#666" style={styles.infoIcon} />
              <Text style={styles.infoText}>They will be directed to your digital menu</Text>
            </View>
            <View style={styles.infoItem}>
              <Icon name="shopping-cart" size={16} color="#666" style={styles.infoIcon} />
              <Text style={styles.infoText}>Customers can browse and place orders directly</Text>
            </View>
          </View>
        </Card>
      </ScrollView>
